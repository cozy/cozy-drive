...
export default class Page {
    constructor () {
        ...
        this.btnUpload = Selector('[class^="pho-toolbar"]').find('span').find('input');
        ...
        this.photoNavNextBtn = this.photoNavNext.find('[class^="pho-viewer-nav-arrow"]');
        this.photoNavPrevious = Selector('[class*="pho-viewer-nav--previous"]');
        this.photoNavPreviousBtn = this.photoNavPrevious.find('[class^="pho-viewer-nav-arrow"]');

        this.photoBtnClose = Selector('[class^="pho-viewer-toolbar-close"]').find('[class^="c-btn"]');
        this.photoToolbar = Selector('[class*="coz-selectionbar pho-viewer-toolbar-actions"]'); //.find('button') -> DL button

        this.photoCheckbox = Selector('[class^="pho-photo-select"][data-input="checkbox"]');
        ...
        this.allPhotos = Selector('[class^="pho-photo"]').find('[class^="pho-photo-item"]');
