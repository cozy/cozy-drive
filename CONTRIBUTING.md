...
$ cd cozy-photos-v3
$ git remote add fork git://github.com/cozy/cozy-photos-v3.git
```
...
Go to https://github.com/cozy/cozy-photos-v3 and select your branch. Click the 'Pull Request' button and fill out the form.
