...
const FilesSelectionBar = ({ t, selectedCount, onDownload, onHide, onDelete, onShowActionMenu }) => (
  <div className={styles['coz-selectionbar']} role='toolbar'>
    ...
    <button className={styles['coz-action-download']} disabled={selectedCount < 1} onClick={onDownload}>{t('selectionbar.download')}</button>
    <button className={styles['coz-action-delete']} disabled={selectedCount < 1} onClick={onDelete}>{t('selectionbar.delete')}</button>
    ...
    <button className={classNames('coz-btn', 'coz-btn--extra-white')} disabled={selectedCount < 1} onClick={onShowActionMenu} />
