...
export class Welcome extends Component {
  registerRender = () => {
    const { t, register, allowRegistration, hasSafariPlugin, breakpoints: { isMobile } } = this.props
  ...
  render() {
    const { t, selectServer, breakpoints: { isMobile } } = this.props
        ...
        <div className={styles['wizard-wrapper']}>
          <div className={styles['wizard-main']}>
            <div className={styles['wizard-logo']}>
              <img className={styles['wizard-logo-img']} src={this.context.client.options.oauth.logoURI} alt="" aria-hidden="true" focusable="false" />
              <div className={styles['wizard-logo-badge']} />
            </div>
            <MainTitle tag="h1" className={classNames(styles['wizard-title'], 'u-mb-1-half', 'u-mt-0')}>
              {t('mobile.onboarding.welcome.title')}
            </MainTitle>
            <p className={classNames(styles['wizard-desc'], 'u-mb-1-half')}>{t('mobile.onboarding.welcome.desc')}</p>
          </div>
...
export default withHasSafariPlugin()(withBreakpoints()(connect()(translate()(Welcome))))
